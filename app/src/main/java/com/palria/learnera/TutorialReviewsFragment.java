...
public class TutorialReviewsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View parentView = inflater.inflate(R.layout.fragment_tutorial_reviews, container, false);
        initUI(parentView);
