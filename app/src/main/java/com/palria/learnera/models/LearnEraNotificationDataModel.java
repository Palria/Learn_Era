...
public class LearnEraNotificationDataModel {
    ...
    public LearnEraNotificationDataModel(String notificationId, String title, String message, String dateNotified, ArrayList<String> notificationViewers){
